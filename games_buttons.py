...
GAMES = [
    {"name": "2048 Game", "description": "Merge tiles to reach 2048.", "server_url": f"{serverUrl}:31001", "launcher": launch_2048_game},
    {"name": "Memory Game", "description": "Match pairs of cards.", "server_url": f"{serverUrl}:31002", "launcher": launch_memory_game},
    {"name": "Hangman Game", "description": "Guess the word before time runs out.", "server_url": f"{serverUrl}:80", "launcher": launch_hangman_game},
    {"name": "Mastermind Game", "description": "Crack the color code.", "server_url": f"{serverUrl}:90", "launcher": launch_mastermind_game},
    {"name": "Simon Game", "description": "Follow the color sequence.", "server_url": f"{serverUrl}:31005", "launcher": launch_simon_game},
]
